...
ALLOWED_HOSTS = {{ nautobot.allowed_hosts }} 

# PostgreSQL database configuration. See the Django documentation for a complete list of available parameters:
#   https://docs.djangoproject.com/en/stable/ref/settings/#databases
DATABASES = {
    "default": {
        "NAME": os.getenv("NAUTOBOT_DATABASE", "{{ nautobot.db.name }}"),  # Database name
        "USER": os.getenv("NAUTOBOT_USER", "{{ db_username }}"),  # Database username
        "PASSWORD": os.getenv("NAUTOBOT_PASSWORD", "{{ db_password }}"),  # Datbase password
